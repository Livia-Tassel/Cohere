      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1">
            ...
            <p className="text-sm text-[var(--text-secondary)] mb-4">
              A community-driven Q&A platform for developers to share knowledge and help each other grow.
            </p>
            <div className="flex gap-3">
              <motion.a
                ...
                className="w-8 h-8 rounded-full bg-[var(--bg-tertiary)] flex items-center justify-center text-[var(--text-secondary)] hover:text-[var(--color-primary)] hover:bg-[var(--bg-elevated)] transition-all"
              >
        ...
        <div className="pt-8 border-t border-[var(--border-primary)] flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-[var(--text-tertiary)]">
            © {currentYear} Cohere. All rights reserved.
          </p>
          <div className="flex gap-6">
            <Link
              to="/terms"
              className="text-sm text-[var(--text-tertiary)] hover:text-[var(--color-primary)] transition-colors"
            >
              Terms
            </Link>
            <Link
